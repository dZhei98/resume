...
const STATIC_QR_PATH = "/assets/qr.jpeg";
...
export default function QrPage() {
  ...
  const [qrImageSrc, setQrImageSrc] = useState(STATIC_QR_PATH);
  ...
  const handleQrAssetError = () => {
    ...
    setQrImageSrc(
      getQrImageUrl(new URL(RESUME_PATH, window.location.origin).toString(), 420)
    );
  };
          ...
          <section className="hidden flex-1 items-center gap-6 lg:grid lg:grid-cols-[minmax(0,1fr)_minmax(320px,420px)_minmax(0,1fr)]">
            ...
            <div className="flex flex-col items-center gap-5">
              <header className="text-center">
                ...
                <p className="mt-3 text-xs uppercase tracking-[0.45em] text-red-300/90 sm:text-sm">http://joshuanee.vercel.app/</p>
              </header>
          ...
          <section className="flex flex-1 flex-col items-center justify-center gap-4 lg:hidden">
            ...
            <div className="flex flex-col items-center justify-center gap-3">
              <header className="text-center">
                ...
                <p className="mt-2 text-[10px] uppercase tracking-[0.22em] text-red-300/90">http://joshuanee.vercel.app/</p>
              </header>
